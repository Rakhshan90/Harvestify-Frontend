...
const Register = () => {
  return (
    <div className="min-h-screen dark:bg-slate-800 dark:text-white">
      ...
      <div className="flex flex-col items-start pr-14 py-12 lg:px-12">
        <form className="flex flex-col mx-auto lg:mx-0 space-x-10 lg:flex-wrap lg:h-[500px]">
          <h1 className="text-3xl font-bold font-heading mb-4 pl-10">Sign up</h1>
          {/* display error */}
          <Link
            to="/login"
